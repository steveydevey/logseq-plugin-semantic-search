...
describe("searchEmbeddings", () => {
  const records: EmbeddingRecord[] = [
    { blockId: "a", contentHash: "", embedding: [1, 0, 0], pageId: 1, timestamp: 0 },
    { blockId: "b", contentHash: "", embedding: [0, 1, 0], pageId: 1, timestamp: 0 },
    { blockId: "c", contentHash: "", embedding: [0.7, 0.7, 0], pageId: 2, timestamp: 0 },
  ];
